                ...
                <p>Options:<br></p>
                  <?php
                    ...
                    <div class="myBox">
                      ...
                      <form class="form" action="#" method="post" enctype="multipart/form-data" autocomplete="off" onsubmit="<?php if(isset($_POST['comment']) && $_SESSION['flag']) {$_SESSION['comment_id'] = $id; $_SESSION['flag'] = FALSE;} echo "thujlu";?>" >
                        <div class="alert alert-error"><?= $_SESSION['message'] ?></div>
