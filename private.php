                ...
                <p><b>Options:</b><br></p>
                  <?php
                    ...
                    <div class="myBox">
                      ...
                      <form class="form" action="#" method="post" enctype="multipart/form-data" autocomplete="off" name="<?php echo $row['id'] ?>" onsubmit="">
                        <input type="submit" value="View Statistics" name="view_stats"  class="btn" style="font-size:7pt;color:white;background-color:red;border:2px solid #336600;padding:3px" />
                        <input type="hidden" name="id" value= "<?php echo $row['id'] ?>"/>
                      </form>
