					...
					<div class="col-md-10 col-md-offset-1 text-center">
						<div class="dt js-height">
							<div class="dtc animate-box">
						      ...
						      <input style="width: 300px; " type="text" placeholder="Poll Name" name="name" required /> <br><br>
						      <input style="width: 300px; height: 50px;" type="text" placeholder="Question" name="q1" /> <br><br>
