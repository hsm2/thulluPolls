					...
					<div class="col-md-10 col-md-offset-1 text-center">
						<div class="dt js-height">
							<div class="dtc animate-box">
						      ...
						      <input style="width: 300px; height: 300px;" type="text" placeholder="Poll Name" name="name" required /> <br>
						      <input style="width: 300px; height: 300px;" type="text" placeholder="Question" name="q1" /> <br>
						      <input style="width: 300px; height: 300px;" type="text" placeholder="Answer Choice 1" name="a1"/> <br>
						      <input style="width: 300px; height: 300px;" type="text" placeholder="Answer Choice 2" name="a2"/> <br>
                  <input style="width: 300px; height: 300px;" type="text" placeholder="Answer Choice 3" name="a3"/> <br>
